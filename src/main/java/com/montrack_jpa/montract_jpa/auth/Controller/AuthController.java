package com.montrack_jpa.montract_jpa.auth.Controller;

import com.montrack_jpa.montract_jpa.auth.Entity.UserAuth;
import com.montrack_jpa.montract_jpa.auth.dto.LoginRequestDto;
import com.montrack_jpa.montract_jpa.auth.dto.LoginResponseDto;
import com.montrack_jpa.montract_jpa.auth.service.AuthService;
import com.montrack_jpa.montract_jpa.responses.Response;
...
public class AuthController {
    ...
    public ResponseEntity<?> login (@RequestBody LoginRequestDto userLogin) throws IllegalAccessException{
        log.info("User login request recieved for user:" + userLogin.getEmail());
